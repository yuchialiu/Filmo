...
(function ($, window, document, undefined) {
  ...
  Owl.prototype.trigger = function (name, data, namespace, state, enter) {
    ...
    const event = $.Event([name, 'owl', namespace || 'carousel'].join('.').toLowerCase(), $.extend({ relatedTarget: this }, status, data));
  ...
  $.fn.owlCarousel = function (option) {
    ...
    return this.each(function () {
      ...
      if (!data) {
        ...
        $.each(['next', 'prev', 'to', 'destroy', 'refresh', 'replace', 'add', 'remove'], (i, event) => {
...
(function ($, window, document, undefined) {
  ...
  Navigation.prototype.update = function () {
    ...
    const { settings } = this._core;
    const size = settings.center || settings.autoWidth || settings.dotsData ? 1 : settings.dotsEach || settings.items;
  ...
  Navigation.prototype.current = function () {
    ...
    return $.grep(
      this._pages,
      $.proxy((page, index) => page.start <= current && page.end >= current, this)
    ).pop();
  };
