...
--
-- Table structure for table `movie_translation`
--
...
CREATE TABLE `movie_translation` (
  ...
  `spoken_languages` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `movie_id` (`movie_id`,`locale`),
  CONSTRAINT `movie_translation_ibfk_1` FOREIGN KEY (`movie_id`) REFERENCES `movie` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
